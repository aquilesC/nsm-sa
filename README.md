...
```
cd existing_repo
git remote add origin https://gitlab.com/langhammerlab/nsm-sa.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/langhammerlab/nsm-sa/-/settings/integrations)
